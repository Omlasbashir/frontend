...
//     customer: { name: "", email: "", phone: "", district: "", neighborhood: "" },
//     service: { serviceId: "", washing: false, ironing: false, washKg: 0, ironKg: 0 },
//     delivery: "none"
//   });

//   useEffect(() => {
//     axios.get("http://localhost:3000/read/service").then(res => setServices(res.data));
//   }, []);

//   const handleChange = (e) => {
//     const { name, value, type, checked } = e.target;
//     if (name in formData.customer) setFormData({ ...formData, customer: { ...formData.customer, [name]: value } });
//     else if (name in formData.service) setFormData({ ...formData, service: { ...formData.service, [name]: type === "checkbox" ? checked : Number(value) } });
...
//       <input type="text" name="neighborhood" placeholder="Neighborhood" onChange={handleChange} required />
...
//       <label>
//         <input type="checkbox" name="washing" checked={formData.service.washing} onChange={handleChange} /> Washing
//       </label>
//       {formData.service.washing && <input type="number" name="washKg" value={formData.service.washKg} onChange={handleChange} min={0} />}

//       <label>
//         <input type="checkbox" name="ironing" checked={formData.service.ironing} onChange={handleChange} /> Ironing
//       </label>
//       {formData.service.ironing && <input type="number" name="ironKg" value={formData.service.ironKg} onChange={handleChange} min={0} />}
